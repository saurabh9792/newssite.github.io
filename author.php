        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                 ...
                 <?php
                 include "config.php";  // database configration
                 if(isset($_GET["aid"])){
                 $auth_id=$_GET["aid"];
                  ...
                  if(isset($_GET["cid"])){
                    $cat_id=$_GET["cid"];
                      ...
                      $sql="SELECT post.post_id,post.title,post.description,post.post_date,post.author,
                       category.category_name,user.username,post.post_img,post.category FROM post  
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="inner-content clearfix">
                                        <h3><a  style="color:#F44336;" href="single.php?id=<?php echo $row["post_id"];?>"><?php echo $row['title'];?></a></h3>
                                        <div class="post-information">
                                            <span>
                                                <i style="color:#F44336;" class="fa fa-tags" aria-hidden="true"></i>
                                                <a href='category.php?cid=<?php echo $row["category"];?>'><?php echo $row['category_name'];?></a>
                                            </span>
                                            <span>
                                                <i style="color:#F44336;" class="fa fa-user" aria-hidden="true"></i>
                                        ...
                                        <a style="background-color:#F44336;" class='read-more pull-right' href="single.php?id=<?php echo $row["post_id"];?>">read more</a>
                                    </div>
                                </div>
                            </div>
                            </div>
