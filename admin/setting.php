  ...
  <!-- Form -->
        <form action="save-setting.php" method="POST" enctype="multipart/form-data" autocomplete="off">
          <div class="form-group">
                ...
                <input type="text" name="website_name"  class="form-control" id="website_name" value="<?php echo $row["websitename"];?>">
            </div>
         <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="footer_desc" class="form-control" value=""  required rows="5">
